(function() {
  ...
  ABM.Evented = (function() {
    ...
    Evented.prototype.on = function(name, cb) {
      var _base1;
      return ((_base1 = this.events)[name] != null ? _base1[name] : _base1[name] = []).push(cb);
    };
  ...
  ABM.Animator = (function(_super) {
    ...
    function Animator(model, rate, multiStep) {
      ...
      this.reset();
      Animator.__super__.constructor.call(this);
    }
  ...
  ABM.Model = (function(_super) {
    ...
    Model.prototype.extend = function(aClass) {
      ...
      model = this;
      extendedClass = (function(_super1) {
        __extends(extendedClass, _super1);
    ...
    Model.prototype.createBreeds = function(s, agentClass, breedSet) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        b = _ref[_i];
        c = Breed = (function(_super1) {
          __extends(Breed, _super1);
